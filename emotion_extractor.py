...
class EmotionExtractor:
    ...
    VOCAL_QUALITY_KEYWORDS = {
        'whisper', 'shout', 'shouting', 'voice breaking', 'voice breaks', 'voice cracks',
        'hoarse', 'strained', 'trembling', 'breathless', 'breaking', 'cracking',
        'quiet', 'quieter', 'loud', 'louder', 'soft', 'softer', 'sharp', 'measured',
        'gentle', 'firm', 'steady', 'unsteady', 'faltering', 'clear', 'muffled',
        'raspy', 'gravelly', 'shaky', 'stable', 'controlled', 'tense', 'tight',
        'strained', 'relaxed', 'calm voice', 'urgent voice'
    }

    EMOTION_KEYWORDS = {
        'panicked', 'panic', 'calm', 'calmer', 'angry', 'anger', 'sad', 'sadness',
        'hopeful', 'hope', 'desperate', 'desperation', 'relieved', 'relief',
        'scared', 'fear', 'fearful', 'terrified', 'anxious', 'anxiety', 'worried',
        'concern', 'concerned', 'happy', 'joy', 'excited', 'excitement',
        'frustrated', 'frustration', 'annoyed', 'irritated', 'pleased', 'satisfied',
        'disappointed', 'disappointment', 'surprised', 'shock', 'shocked',
        'confused', 'confusion', 'determined', 'resignation', 'resigned',
        'nervous', 'tense', 'stressed', 'overwhelmed', 'vulnerable', 'honest',
        'amused', 'cynical', 'suspicious', 'weary', 'distant', 'impressed',
        'thoughtful', 'considering', 'empathetic', 'sympathetic', 'cold', 'warm'
    }

    PHYSICAL_KEYWORDS = {
        'coughing', 'cough', 'gasping', 'gasp', 'choking', 'choke',
        'breathing heavily', 'breathing', 'breath', 'sighing', 'sigh',
        'laughing', 'laugh', 'chuckle', 'crying', 'sob', 'sobbing',
        'sniffling', 'clearing throat', 'swallowing', 'gulp', 'panting',
        'wheezing', 'groaning', 'groan', 'grunting', 'exhale', 'inhale',
        'sharp intake', 'intake of breath'
    }
    ...
    PACING_KEYWORDS = {
        'pause', 'long pause', 'beat', 'silence', 'long silence',
        'quick', 'quickly', 'fast', 'rapid', 'rushed', 'hurried',
        'slow', 'slowly', 'measured', 'deliberate', 'hesitant',
        'hesitation', 'stuttering', 'stammering'
    }
    ...
    def _map_physical_to_emotion(self, keyword: str) -> str:
        ...
        distress_indicators = [
            'coughing', 'cough', 'gasping', 'gasp', 'choking', 'choke',
            'breathing heavily', 'wheezing', 'groaning', 'panting', 'breathing'
        ]
    ...
    def _map_vocal_to_emotion(self, keyword: str) -> str:
        ...
        distress_vocals = {
            'voice breaking', 'voice breaks', 'voice cracks', 'breaking', 'cracking',
            'hoarse', 'strained', 'trembling', 'breathless', 'unsteady', 'faltering',
            'shaky', 'raspy', 'tense', 'tight'
        }
        calm_vocals = {
            'measured', 'steady', 'controlled', 'calm voice', 'clear', 'stable', 'relaxed'
        }
