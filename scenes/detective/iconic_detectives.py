...
class IconicDetectives(Scene):
    ...
    def __init__(self):
        ...
        art_assets = SceneArtAssets(scene_type="character", background_image=None, audio=audio)
        ...
        opening_speech = [
            Line(
                text="Hello? Is this Iconic Detectives? [pause] I'm calling about a case. Someone's dead, and the story you've been told is wrong.",
                delay=0,
            ),
            Line(
                text="Before you ask - I can't give my full name. Not yet. Just listen.", delay=2.5
            ),
            Line(
                text="It's about Dr. Elias Crowe. They're calling it a robbery gone wrong. That's nonsense.",
                delay=4.5,
            ),
            Line(
                text="He was found in his Marlow Street townhouse last night. But the thing that doesn't fit is the timing - and what was taken.",
                delay=6.5,
            ),
            Line(
                text="It wasn't valuable. It was specific. A small metal key. Something older. Like it belongs to a lockbox.",
                delay=9.0,
            ),
        ]
