...
class Submarine(Scene):
    ...
    def __init__(self):
        ...
        audio = AudioAssets(
            ...
            volume_levels={"music": 0.3, "sfx": 0.7, "voice": 1.0},
        )
        ...
        state_variables = [
            ...
            StateVariable(
                name="systems_repaired", initial_value=0, min_value=0, max_value=4, update_rate=0.0
            ),
            StateVariable(
    ...
    def achieve_milestone(self, milestone: str) -> None:
        ...
        if milestone not in self.achieved_milestones:
            ...
            logging.getLogger(__name__).info("[Submarine] Milestone achieved: %s", milestone)
