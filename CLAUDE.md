...
facts = [
    "Lt. Commander James Kovich has a son named Adrian aboard.",
...
### 10. World Labs 3D Environment Integration
...
2. **Register scene** (`scenes/__init__.py`):
...
3. **Add mapping** (`config/scene_mappings.json`):
...
4. **Optional: Create handler** (only if custom button logic needed):
